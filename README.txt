...
Step 3:
Next open FormattingCheatSheet.txt and NewFormattingCheatSheet.txt. This is open in the center of your screen. It may be useful to drag both FormattingCheatSheet.txt and NewFormattingCheatSheet.txt from the center window to the upper right window, so you can see one of them at the same time as this file. (Do this by grabbing the header and dragging and dropping). 
...
Step 6:
In order to know which sheet cheat to use, you can choose to Show Available Columns. If 'y' is entered, then the printed headings should be included within the formatting cheat sheet that you are using.
